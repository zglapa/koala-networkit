...
class InclusionExclusionVertexColoringDimacsTest
...
// }, { 4, 7 }, { 4, 8 }, { 4, 9 }, { 5, 6 }, { 5, 8 }, { 5, 9 }, { 6, 7 }, { 6, 8 }, { 6, 9 }, { 7,
// 8 }, { 7, 9 }, { 8, 9 } }, 5 }, InclusionExclusionParameters{ 4, { { 0, 2 }, { 1, 3 }, { 2, 3 }
// }, 2 }, InclusionExclusionParameters{ 9, { { 0, 4 }, { 0, 5 }, { 0, 6 }, { 0, 8 }, { 1, 5 }, { 1,
// 6 }, { 1, 7 }, { 1, 8 }, { 2, 6 }, { 3, 7 }, { 3, 8 }, { 4, 5 }, { 4, 7 }, { 4, 8 }, { 5, 7 }, {
// 5, 8 }, { 6, 7 }, { 7, 8 } }, 4 }));

TEST_P(InclusionExclusionVertexColoringDimacsTest, testDimacsGraphs) {
    auto parameters = GetParam();
...
INSTANTIATE_TEST_SUITE_P(test,
InclusionExclusionVertexColoringDimacsTest,
